...
import { Coffee, House, PhoneCall, UserSearch, BadgeCheck, Menu, X } from "lucide-react";
...
function Navigation() {
  ...
  return (
    <div className="right-section max-500:w-fit">
      ...
      <div
        className={`navigation-content md:block ${menuOpen ? "block" : "hidden"} max-500:mt-12 max-500:pt-5`}
      >
