...
function ContactLogos() {
  return (
    <div className=" my-6">
      <h2 className="text-white text-2xl font-semibold mb-4">Find me on social media</h2>
      <div className="flex justify-center space-x-4 max-500:flex-col max-500:items-center gap-3">
        ...
        >
          <img src="/Icons/google-gmail.svg" alt="Email Icon" className="w-5 h-5 mr-2 filter invert" />
          Email
        </a>
        ...
        <a 
          ...
          rel="noopener noreferrer"
        >
          <img src="/Icons/linkedin-icon.svg" alt="LinkedIn Icon" className="w-5 h-5 mr-2" />
          LinkedIn
        </a>
  ...
  rel="noopener noreferrer"
>
  <img src="/Icons/instagram-icon.svg" alt="Instagram Icon" className="w-5 h-5 mr-2" />
  Instagram
</a>
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <img src="/Icons/github-icon.svg" alt="GitHub Icon" className="w-5 h-5 mr-2" />
          GitHub
        </a>
